...
export const mockNavTableRows = [
  ...
  },
  {
    ...
    CommState: "Warning",
    ObjectState: "Good",
    State: "COMM_WARNING|STATE_GOOD|OBJ_ENABLED",
  },
  {
    id: "alh-store",
    name: "EMEA-ESP-ALH-P1-BYESALHS001",
    path: "/System/Core/EMEA-ESP-ALH-P1-BYESALHS001",
    type: "CONNECTOR",
    WorstState: "Good",
    CommState: "Good",
    ObjectState: "Good",
  ...
  {
    id: "qid-mqtt",
    name: "APAC-CN-QID-P1-BCNQIDS0047/MQTT for JAWA",
    path: "/System/Core/APAC-CN-QID-P0-RELAY/APAC-CN-QID-P1-BCNQIDS0047",
    type: "DATASOURCE",
    WorstState: "Good",
    CommState: "Empty",
    ObjectState: "Good",
    State: "COMM_EMPTY|STATE_GOOD|OBJ_ENABLED|OBJ_DYNAMIC",
  },
  {
    id: "webapi",
    name: "Web API Server",
